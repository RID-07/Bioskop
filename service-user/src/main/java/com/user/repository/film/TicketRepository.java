 ...
 */
@Repository
public interface TicketRepository extends JpaRepository<Tiket, String> {
    ...
    @Query(value = "select sum(point) as totalPoint from bioskop.ticket t where email = :email", nativeQuery = true)
    public Integer getTotalPointByEmail(String email);
}
